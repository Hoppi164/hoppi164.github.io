 ...
 * @property {String} summary - The summary of the post to be displayed on the blog list
...
export const allPosts = [
	{
		...
		date: '2020-09-13',
		slug: 'hello-world',
		summary: `I created this blog to act as a mini-repository of challenges, and solutions on my programming journey. Check back regularily for new updates!`,
	...
	},
	{
		...
		summary: `Don't use "if statements" with lots of possible outcomes! It's best to avoid this if possible, because "if statements" can get very ugly and difficult to read; "switch statements" are better, but not by much. The third option is much cleaner and exponentially more efficient.`,
...

	{
		...
		summary: `A silly childs game can pose an interesting challenge for software development. Programming the game rules can be approached in many different ways`,
